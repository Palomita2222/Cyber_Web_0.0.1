...
mailinpt = int(input(Fore.LIGHTBLUE_EX+"[CHOICE] Do you want to use a random email, or your own? (1 o 2) > "))
if mailinpt == 1:
    email = (random.choice(names)+"@"+random.choice(mails))
    print(Fore.LIGHTGREEN_EX+"The random email generated is: > ")
...
password = input(Fore.LIGHTBLUE_EX+"[PASS] Write the server's password (Min 6 caracteres) > ")
os.system('cls' if os.name == 'nt' else 'clear')
print(Fore.LIGHTCYAN_EX+banner)
url = input(Fore.LIGHTBLUE_EX+"[URL] Write the website's url(No spaces or special chars) > ")
os.system('cls' if os.name == 'nt' else 'clear')
